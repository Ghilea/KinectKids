# Generates Unity sprite .meta files for every PNG under a folder that lacks one.
# Mirrors the working sprite import settings used elsewhere in the project
# (textureType Sprite, single sprite, custom bottom-centre pivot, alpha is
# transparency). Each file gets a fresh deterministic GUID.
param(
...
TextureImporter:
  ...
  spriteMeshType: 1
  alignment: 9
  spritePivot: {x: __PX__, y: __PY__}
  spritePixelsToUnits: 280
