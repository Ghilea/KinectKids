...
|---|---|---|
| Stationen | Välkomstskylt och lila blacklight | enkla spöken lär ut siktet |
| Kryptan | gravstenar och gröna spökljus | mål på båda sidor av vagnen |
| Verkstaden | rör, giftbubblor och zombies | tätare vågor och tvåträffsmål |
| Finalhallen | orange portal och dramatisk belysning | zombie-konduktör med livsmätare |
...
- Varje hand har eget mållås. En träff kräver cirka 0,46 sekunder på samma 3D-collider.
